    ...
    <footer className="container mx-auto flex w-full flex-col justify-between gap-3 p-6">
      ...
      <div className="flex w-full flex-col items-center justify-between gap-4 md:flex-row">
        ...
        <div className="flex items-center gap-3">
          <Link href={'https://x.com/realXmarketuk'} className="text-black hover:text-primary-300">
            <Icons.xTwitter className="size-6" />
          </Link>
          <Link href={'https://discord.gg/4d5Pxq5q'} className="text-black hover:text-primary-300">
          ...
          <Link href={'https://www.youtube.com/@Xcavate-RealXMarket'} className="text-black hover:text-primary-300">
