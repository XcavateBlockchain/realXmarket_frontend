...
import ProfileHeaderOverview from './components/lawyer-overview';
...
export default async function LawyerLayout({ children }: Readonly<ProfileLayoutProps>) {
  ...
  return (
    <>
      ...
      <div className="container relative mx-auto flex min-h-screen max-w-screen-2xl flex-col items-start justify-start gap-10 px-4 py-[140px] md:px-4 lg:gap-16 lg:px-[50px]">
        ...
        <ProfileTabs items={tabConfig.lawyer} />
        {children}
      </div>
    </>
  );
